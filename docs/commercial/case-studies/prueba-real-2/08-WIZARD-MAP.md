# Mapa wizard ↔ pasos Operador B (prueba-real-2)

URL base: http://137.184.66.163/institucional/piloto

| Checklist B | UI wizard (stepper) | Qué buscar en pantalla |
|-------------|---------------------|-------------------------|
...
Tras capturas: `node scripts/verify-operador-b-pack.mjs`
