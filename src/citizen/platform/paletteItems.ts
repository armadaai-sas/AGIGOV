...
export const PALETTE_ITEMS: readonly PaletteItem[] = [
  ...
  { id: 'modelo', label: 'Modelos', to: '/#modelos', group: 'Gobernanza 2.0', keywords: 'pilares gobernanza' },
  ...
  { id: 'descargar', label: 'App de escritorio', to: '/descargar', group: 'Recursos', keywords: 'desktop windows mac linux electron descargar instalador' },
  ...
  { id: 'contratos', label: 'Custodia · Contratos', to: '/contratos', group: 'Operación', keywords: 'hitos centinela custodia' },
  { id: 'transparencia', label: 'Transparencia', to: '/transparencia', group: 'Operación', keywords: 'aei contrato eficiencia dictamen' },
  { id: 'gestion', label: 'Gestión pública', to: '/gestion', group: 'Operación', keywords: 'panel telemetría ledger transparencia' },
