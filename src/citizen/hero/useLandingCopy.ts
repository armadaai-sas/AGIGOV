...
export function useLandingCopy() {
  ...
  return useMemo(() => {
    ...
    return {
      ...
      LANDING_WHY_ITEMS: [
        { id: 'state', title: t('landing.why.state.title'), body: t('landing.why.state.body') },
        ...
        { id: 'future', title: t('landing.why.future.title'), body: t('landing.why.future.body') },
      ] as const,
      ...
      LANDING_CONTACT_CONCIERGE: t('landing.contact.concierge'),
      LANDING_CONTACT_REGISTER: t('landing.contact.register'),
      ...
      LANDING_PROCESS_STEPS: [
        ...
        { id: 'deploy', title: t('landing.process.deploy.title'), body: t('landing.process.deploy.body') },
      ] as const,
