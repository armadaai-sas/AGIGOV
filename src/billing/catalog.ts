...
export function buildChargeCatalog(plan: AgigovPlan = resolvePlan()): {
  ...
  const lines: ChargeLine[] = [
    ...
    },
    {
      ...
      priceUsd: 'pct_delta',
      priceNote: `${EGS_SPLIT.agigovFee * 100}% Δ · rev-share Manifest v1 (65/30/5 del fee) · $0 si Δ≤0 · add-on opcional`,
      ledgerSource: 'QuarterClose.calculoAhorroFinal + agigovFeeAmount + evidenceBundle.egsFeeShare',
      payer: 'tenant_state',
